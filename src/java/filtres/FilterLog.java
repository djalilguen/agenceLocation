...
public class FilterLog implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String ligne = "IP : " + ip + ", " + new Date().toString() + "\n";
        ecritureFichier(ligne);
        chain.doFilter(request, response);

    }

    private void ecritureFichier(String ip) {
        String fichier = "Logs/JournalLog.txt";
        String realpath = getFilterConfig().getServletContext()
                .getRealPath(fichier);
        ...
        try {
            ...
            if (inFile != null) {
                try {
                    ...
                    Logger.getLogger(FilterLog.class.getName()).
